		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 text-center mb-5">
					...
					<h2 class="heading-section">Selamat Datang <br> di Monitoring Hidroponik</h2>
          <?php 
          if(isset($_GET['pesan'])){
            if($_GET['pesan']=="gagal"){
              echo '<div class="alert alert-danger" role="alert">
                <span class="badge badge-pill badge-success"></span>SAP atau Password salah
                </div>            
                </div>';
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
						<div class="img" style="background-image: url(html/assets/images/logos/logo_login.png );">
			      </div>
